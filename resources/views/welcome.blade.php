...
@section('content')
        <h1>Welcome to PHPSpellChecker</h1>
...
You can either fix the typo in your webproject or you can add a word to your custom dictionary. After adding a word to a dictionary you need to compile the dictionary, so that the PHPSpellChecker can consider your custom word entry.
@endsection